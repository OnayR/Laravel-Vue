...
<template>
    ...
    <div class="flex items-center gap-x-3">
        ...
        <span class="px-3 py-1 text-xs text-blue-600 bg-blue-100 rounded-full dark:bg-gray-800 dark:text-blue-400">{{ users.length }}</span>
    </div>
                    ...
                    <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                        <thead class="bg-gray-50 dark:bg-gray-800">
                            <tr>
                                ...
                                <th scope="col" class="px-4 py-3.5 text-sm font-normal text-left rtl:text-right text-gray-500 dark:text-gray-400">Homes</th>
                        ...
                        <tbody v-if="users.length" class="bg-white divide-y divide-gray-200 dark:divide-gray-700 dark:bg-gray-900">
